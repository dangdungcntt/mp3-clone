<template>
  <div class="wrap-sidebar">
    ...
    <div id="topic-hot" class="widget widget-cate">
        ...
        <ul class="clearfix">
          ...
          <li>
            <a href="/chu-de/Zing-Music-Awards-2017/IWZ99F06.html#home_chude_01" title="Zing Music Awards 2017"
              ...
              <span class="des">
                                        <span class="sum-pci">Zing Music Awards là giải thưởng âm nhạc thường niên do Zing MP3 tổ chức nhằm tôn
                                            vinh các sản phẩm âm nhạc của nghệ sĩ đạt được thành tích tốt trong năm.</span>
                                    </span>
            </a>
          </li>
          ...
          <li>
            <a href="/chu-de/nhac-hot/IWZ9Z0C8.html#home_chude_02" title="Nhạc Hot" class="_trackLink"
              ...
              <span class="des">
                                        <span class="sum-pci">Zing Mp3 sẽ mang đến các ca khúc HOT mới nhất, từ các nghệ sỹ bạn yêu thích.</span>
                                    </span>
            </a>
          </li>
          ...
          <li>
            <a href="/chu-de/Lam-Viec/IWZ9ZI9O.html#home_chude_03" title="Làm Việc" class="_trackLink"
              ...
              <span class="des">
                                        <span class="sum-pci">Âm nhạc giúp bạn xua tan căng thẳng trong công việc thường ngày.</span>
                                    </span>
            </a>
          </li>
          ...
          <li>
            <a href="/chu-de/Ca-Phe/IWZ9ZI6Z.html#home_chude_04" title="Cà Phê" class="_trackLink"
              ...
              <span class="des">
                                        <span class="sum-pci">Chọn cho mình một "gu" âm nhạc phù hợp nhất khi đang thưởng thức ly cafe nhé !</span>
                                    </span>
            </a>
          </li>
          ...
          <li>
            <a href="/chu-de/Acoustic/IWZ977C8.html#home_chude_05" title="Acoustic" class="_trackLink"
              ...
              <span class="des">
                                        <span
                                          class="sum-pci">Ấm ấp cùng cảm giác dễ chịu với chất mộc của Acoustic.</span>
                                    </span>
            </a>
          </li>
      ...
      <a class="view-more _trackLink" href="/chu-de#home_chude_browser" tracking="_frombox=home_chude_browser">Xem thêm
        Chủ Đề khác</a>
