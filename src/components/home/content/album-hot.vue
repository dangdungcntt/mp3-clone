<template>
  <div class="mt20-">
    ...
    <h2 class="title-section">
      <a href="/the-loai-album.html#home_albumhot_title" title="Album hot">Album hot
    ...
    <div class="row fn-list">
      ...
      <div class="album-item col-3 fn-item">
        ...
        <div class="des">
          <h3 class="title-item ellipsis-2">
            <a href="/album/Thay-La-Yeu-Thuong-Single-OnlyC/ZO698ZBW.html#home_albumhot_01" title="Thấy Là Yêu Thương (Single) - OnlyC"
               class="txt-primary fn-name fn-link _trackLink" tracking="_frombox=#home_albumhot_01">
      ...
      <div class="album-item col-3 fn-item">
        ...
        <div class="des">
          <h3 class="title-item ellipsis-2">
            <a href="/album/Buon-Cua-Anh-Masew-Mix-Masew-Dat-G-K-ICM/ZOA9FOB9.html#home_albumhot_02" title="Buồn Của Anh (Masew Mix) - Masew, Đạt G, K-ICM"
               class="txt-primary fn-name fn-link _trackLink" tracking="_frombox=#home_albumhot_02">
      ...
      <div class="album-item col-3 fn-item">
        ...
        <div class="des">
          <h3 class="title-item ellipsis-2">
            <a href="/album/I-Want-You-Now-Single-Huong-Tram/ZOA9IB9B.html#home_albumhot_03" title="I Want You Now (Single) - Hương Tràm"
               class="txt-primary fn-name fn-link _trackLink" tracking="_frombox=#home_albumhot_03">
              I Want You Now (Single)
            </a>
          </h3>
        </div>
        <div class="inblock fn-artist_list ellipsis">
      ...
      <div class="album-item col-3 fn-item">
        ...
        <div class="des">
          <h3 class="title-item ellipsis-2">
            <a href="/album/Ai-Da-Tung-Single-Hong-Duong/ZOAAOO8W.html#home_albumhot_04" title="Ai Đã Từng (Single) - Hồng Dương" class="txt-primary fn-name fn-link _trackLink"
               tracking="_frombox=#home_albumhot_04">
              Ai Đã Từng (Single)
            </a>
          </h3>
        ...
        <div class="inblock fn-artist_list ellipsis">
          ...
          <h4 class="singer-name txt-info fn-artist">
            <a href="/nghe-si/Hong-Duong-M4U" title="Nghệ sĩ Hồng Dương">Hồng Dương</a>
          </h4>
      ...
      <div class="album-item col-3 fn-item">
        ...
        <div class="des">
          <h3 class="title-item ellipsis-2">
            <a href="/album/Goi-Em-Single-The-Wings-Band/ZOAAZC6Z.html#home_albumhot_05" title="Gọi Em (Single) - The Wings Band" class="txt-primary fn-name fn-link _trackLink"
               tracking="_frombox=#home_albumhot_05">
              Gọi Em (Single)
            </a>
          </h3>
        ...
        <div class="inblock fn-artist_list ellipsis">
          ...
          <h4 class="singer-name txt-info fn-artist">
            <a href="/nghe-si/The-Wings-Band" title="Nghệ sĩ The Wings Band">The Wings Band</a>
          </h4>
      ...
      <div class="album-item col-3 fn-item">
        ...
        <div class="des">
          <h3 class="title-item ellipsis-2">
            <a href="/album/City-Lights-Single-Chau-Dang-Khoa-Superbrothers/ZOAAZCW9.html#home_albumhot_06" title="City Lights (Single) - Châu Đăng Khoa, Superbrothers"
               class="txt-primary fn-name fn-link _trackLink" tracking="_frombox=#home_albumhot_06">
              City Lights (Single)
            </a>
          </h3>
        </div>
        <div class="inblock fn-artist_list ellipsis">
          ...
          <h4 class="singer-name txt-info fn-artist">
            <a href="/nghe-si/Chau-Dang-Khoa" title="Nghệ sĩ Châu Đăng Khoa">Châu Đăng Khoa</a>
          </h4>
          <span class="ft">, </span>

          <h4 class="singer-name txt-info fn-artist">
            <a href="/nghe-si/Superbrothers" title="Nghệ sĩ Superbrothers">Superbrothers</a>
          </h4>
      ...
      <div class="album-item col-3 fn-item">
        ...
        <div class="des">
          <h3 class="title-item ellipsis-2">
            <a href="/album/Album-Sing-My-Song-season-1-Team-Nguyen-Hai-Phong-Hong-Ngoc-Ung-Dai-Ve-Phan-Manh-Quynh-Vicky-Nhung-GREY-D-Doan-The-Lan-Tran-Dung-Khanh-Bui-Cong-Nam/ZOA8FO8A.html#home_albumhot_07"
               title="Album Sing My Song season 1 - Team Nguyễn Hải Phong - Hồng Ngọc, Ưng Đại Vệ, Phan Mạnh Quỳnh, Vicky Nhung, GREY-D (Đoàn Thế Lân), Trần Dũng Khánh, Bùi Công Nam"
               class="txt-primary fn-name fn-link _trackLink" tracking="_frombox=#home_albumhot_07">
              Album Sing My Song season 1 - Team Nguyễn Hải Phong
            </a>
          </h3>
        </div>
        <div class="inblock fn-artist_list ellipsis">
      ...
      <div class="album-item col-3 fn-item">
        ...
        <div class="des">
          <h3 class="title-item ellipsis-2">
            <a href="/album/The-Greatest-Showman-OST-Various-Artists/ZOAA978U.html#home_albumhot_08" title="The Greatest Showman OST - Various Artists"
               class="txt-primary fn-name fn-link _trackLink" tracking="_frombox=#home_albumhot_08">
      ...
      <div class="album-item col-3 fn-item">
        ...
        <div class="des">
          <h3 class="title-item ellipsis-2">
            <a href="/album/Havana-Single-Camila-Cabello/ZO6Z0B88.html#home_albumhot_09" title="Havana (Single) - Camila Cabello" class="txt-primary fn-name fn-link _trackLink"
               tracking="_frombox=#home_albumhot_09">
              Havana (Single)
            </a>
          </h3>
      ...
      <div class="album-item col-3 fn-item">
        ...
        <div class="des">
          <h3 class="title-item ellipsis-2">
            <a href="/album/SO-HOT-THEBLACKLABEL-Remix-Black-Pink/ZOAAW6U0.html#home_albumhot_10" title="SO HOT (THEBLACKLABEL Remix) - Black Pink"
               class="txt-primary fn-name fn-link _trackLink" tracking="_frombox=#home_albumhot_10">
        ...
        <div class="inblock fn-artist_list ellipsis">
          ...
          <h4 class="singer-name txt-info fn-artist">
            <a href="/nghe-si/Black-Pink" title="Nghệ sĩ Black Pink">Black Pink</a>
          </h4>
      ...
      <div class="album-item col-3 fn-item">
        ...
        <div class="des">
          <h3 class="title-item ellipsis-2">
            <a href="/album/I-m-Not-A-Robot-OST-Part-3-Kim-Yeon-Ji/ZOAA8WZW.html#home_albumhot_11" title="I’m Not A Robot OST Part.3 - Kim Yeon Ji"
               class="txt-primary fn-name fn-link _trackLink" tracking="_frombox=#home_albumhot_11">
              I’m Not A Robot OST Part.3
            </a>
          </h3>
        </div>
        <div class="inblock fn-artist_list ellipsis">
          ...
          <h4 class="singer-name txt-info fn-artist">
            <a href="/nghe-si/Kim-Yeon-Ji" title="Nghệ sĩ Kim Yeon Ji">Kim Yeon Ji</a>
          </h4>
      ...
      <div class="album-item col-3 fn-item">
        ...
        <div class="des">
          <h3 class="title-item ellipsis-2">
            <a href="/album/Yes-I-Do-Single-OnlyC-Lou-Hoang/ZOAB8W6I.html#home_albumhot_12" title="Yes I Do (Single) - OnlyC, Lou Hoàng"
               class="txt-primary fn-name fn-link _trackLink" tracking="_frombox=#home_albumhot_12">
              Yes I Do (Single)
            </a>
          </h3>
        </div>
